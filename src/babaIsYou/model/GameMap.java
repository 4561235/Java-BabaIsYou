...
public class GameMap {
	...
	private ArrayList<Item> itemsOnMap = new ArrayList<>(); //Here we put all items that we put on the grid.
	//This reduce the complexity because instead of scanning all the grid to find an item, just iterate over this list

	private ArrayList<Item> itemsOnBackground = new ArrayList<>(); //Here we have all items that are on background
